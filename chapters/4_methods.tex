...
Following feature selection (see Supplementary Material for details), the following features were included in the model: prior disability, stroke severity, age, congestive heart failure, hypertension, diabetes, AFib anticoagulant, AFib diagnosis, onset to thrombolysis time, onset to thrombectomy time, stroke team, ethnicity. Onset to thrombolysis time, onset to thrombectomy time were modelled as either continuous variables, or according to early/late grousp as above.
