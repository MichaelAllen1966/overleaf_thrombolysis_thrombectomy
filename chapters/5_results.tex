...
\begin{longtable}[]{@{}llll@{}}\caption{Descriptive statistics for matched pair analysis of treatment strategies. Strategies are defined by early ($<$ 270 mins from onset) or late ($\geq$ 270 mins from onset) intravenous thrombolysis, mechanical thrombectomy, or their combination. Patients were matched in each treatment strategy on prior disability, age group (5 year bands), stroke severity (NIHSS 0-5,5-9, 10-14, \textit{et seq}, Afib anti-coagulant, and Afib diagnosis. Non-matched patients (a maximum of 2.3\% of each group) were dropped from the analysis. Values show mean and standard deviaiton.}\\
\toprule\noalign{}
Treatment group & Feature & Treated & Untreated \\
\midrule\noalign{}
\endhead
\endlastfoot
